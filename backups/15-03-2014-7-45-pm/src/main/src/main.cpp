...
void entity_logic_loop(map* ptrmap)
{
...
//        for (int in=0; in<20; in++) //for loop 16 times.
//        {
//            
//            for (int i=0; i<20; i++) //for loop 9 times
//            {
//                if (ptrmap->boolMap[in][i] == true) //if there is an entity in map location then render it.
//                {
//                    std::cout << "rendering entity at: "<< in << "/" << i << " " << (in*i) << "\n";
//                    ptrmap->entityMap[in][i]->render(); //render entities.
//                }
//                
//            }
//        }
